...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="bg-gray-50 rounded-md px-8 py-6 text-gray-500">
        {text}
      </div>

      <div className="opacity-0 mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <a
